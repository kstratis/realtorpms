...
module DatasetHelpers
  ...
  def use_regular_dataset
    ...
    @account1_properties = FactoryBot.create_list(:propertysequence, 10, account: @account1)
    @account2_properties = FactoryBot.create_list(:propertysequence, 20, account: @account2)
