  ...
  def filter_properties(relation, filters = {})
    ...
    @properties.each do |property|
      hash = {
        ...
        pricepersqmeter: property.price && property.size ? "#{ActionController::Base.helpers.number_to_currency(property.pricepersqmeter, precision: 0, round_mode: :up)} / #{I18n.t('activerecord.attributes.property.sm_html')}" : '',
