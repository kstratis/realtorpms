      ...
      {sample ? (
        <div className={`d-inline-block`}>
          <div className="sample-ribbon">
            <span>{i18n['sample']}</span>
          </div>
        </div>
      ) : allAreFalsy([spitogatosSync, websiteEnabled, pinned]) ? null : (
        <div className={`d-inline-block`}>
          <div className="info-ribbon">
            {websiteEnabled ? (
              <span
                className="pinned-badge pinned-globe"
                data-toggle="tooltip"
                data-position="top"
                title={i18n['website_enabled']}>
            ...
            {pinned ? (
              <span
                className="pinned-badge pinned-bookmark"
                data-toggle="tooltip"
                data-position="top"
                title={i18n['pinned']}>
