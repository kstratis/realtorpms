...
$(document).on('turbolinks:load', function(e) {
   ...
   * It then append this upload key to autogenerated hidden form fields and submits these along with the rest form
   ...
   * 3. Once Parsley validations pass, then the system keeps track of whether a user have used any attachments or not:
