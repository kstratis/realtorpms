...
Rails.application.configure do
  ...
  # Enable serving of images, stylesheets, and JavaScripts from an asset server.
   config.action_controller.asset_host = 'https://d13refwsasr6jm.cloudfront.net'
  ...
  # config.active_job.queue_name_prefix = "propertyx_#{Rails.env}"
  ...
  #
  config.action_mailer.default_url_options = { :host => "dev.propertize.io" }
  config.action_mailer.delivery_method = :smtp
  config.action_mailer.smtp_settings = {
      address: 'smtp.sendgrid.net',
      port: 587,
      domain: "dev.propertize.io",
