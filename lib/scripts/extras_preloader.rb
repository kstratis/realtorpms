...
ActiveRecord::Base.transaction do
  ...
  %w(gas solar_water_heating furnished fireplace awnings clima security_door pool elevator no_utility_bills fit_for_professional_use parking load_ramp service_lift alarm equipment balcony investment within_urban_plan agricultural_use exchange_scheme).each do |extra|
